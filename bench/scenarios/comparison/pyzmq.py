#!/usr/bin/env python3
"""
PUSH/PULL + REQ/REP throughput on CPython + pyzmq (Cython over libzmq).
Counterparts: omq.cr (this repo), omq.rb (Ruby OMQ), jeromq.java (JeroMQ).

Usage: python3 bench/scenarios/comparison/pyzmq.py
"""
...
if __name__ == "__main__" and len(sys.argv) == 1:
    # libzmq 4.3.5 can assert during teardown between successive REQ/REP
    # runs even with fresh contexts. Fresh subprocess per size sidesteps it.
    import subprocess
